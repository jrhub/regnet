...
Network-based regularization has achieved success in variable selection for 
    ...
    regularization for generalized linear models. Robust network regularization for 
    survival response is a recent addition. This current version, regnet0.3.0, focuses on binary and survival outcomes. 
    Functions for continuous and other regularization methods will be included in the 
