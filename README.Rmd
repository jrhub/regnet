...
Network-based regularization has achieved success in variable selections for 
    ...
    version, regnet0.2.0, focuses on binary outcomes. Functions for continuous, survival outcomes 
...
```
* Binaries are available on R CRAN [(link)](https://cran.r-project.org/package=regnet)
