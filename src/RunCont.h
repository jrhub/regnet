...
arma::vec RunCont_robust(arma::mat const &xc, arma::mat const &xg, arma::vec const &y, double lamb1, double lamb2, arma::vec bc0, arma::vec bg0, double r, arma::mat const &a, int p, int pc, char method);
